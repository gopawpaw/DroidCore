 ...
 * 该类实现数字转中文方法
 * @author LiJinHua
 * @version [Android 1.0.0, 2012-3-13]
 */
public class MoneyUtils {
	 ...
	 * @return
	 */
	public static String amountToChinese(Object amount) {
		try{
			if(amount!=null){
				String s = amount.toString();
				return amountToChinese(s);
			}
		}catch(Exception ex){
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			System.out
			.println("210000.00: " + amountToChinese(210000.00));
			
			System.out
			.println("2100001240.00: " + amountToChinese(2100001240.00));
